                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <form class="form card" style="background-color: rgb(229, 231, 235)"
                            action="{{ route('register.actionpegawai') }}" method="POST">
                            @csrf
                            <div class="card_header">
                                ...
                                <h1 class="form_heading">Register Pegawai</h1>
                            </div>
                            <div class="row g-2">
                                <div class="col-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="hidden" value="-" name="kelas">
                                    <input type="hidden" value="-" name="tahun">
                                    <br>
                                    <div class="mb-3">
