                ...
                <table class="table table-secondary table-striped" id="no-more-tables">
                    ...
                    <tbody>
                        @foreach ($kelas as $index=>$kel)
                            <tr>
                                <td data-title="No">{{ $index + $kelas->firstItem() }}</td>
                                <td data-title="Nama Kelas" >{{$kel->nm_kelas}}</td>
                                <td>
                                    <a href="edit_kelas/{{$kel->id}}" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i>Edit</a>
                                    <a href="hapus_kelas/{{$kel->id}}" class="btn btn-danger" onclick="javascript: return confirm('Konfirmasi data akan dihapus');"><i class="fa-solid fa-trash"></i> Hapus</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
