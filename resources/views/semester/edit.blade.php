...
@section('content')
    ...
    <div class="container">
        <form action="{{route('update_uts',$ak->id)}}" method="post">
            @csrf
            ...
            <input type="hidden" class="form-control" name="kelas" value="{{$ak->kelas}}">
            <input type="hidden" class="form-control" name="mapel" value="{{$ak->mapel}}">
            <div>
                <label for="">NIS</label>
            ...
            <div>
                ...
                <input type="number" class="form-control" name="n_akhir" value="{{$ak->n_akhir}}" required >
            </div>
            <div>
                <label for="">Nilai UTS</label>
                <input type="number" class="form-control" name="uts" value="{{$ak->uts}}" required autofocus>
            </div>
            <div>
                <label for="">Nilai UAS</label>
                <input type="number" class="form-control" name="uas" value="{{$ak->uas}}" required>
            </div>
            <br>
            <div>
