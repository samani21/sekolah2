            ...
            <div class="row">
                <div class="col-6">
                    <div>
                        ...
                        <input class="form-control" type="text" name="materi" value="{{$jurnal->materi}}" aria-label="default input example" required autofocus>
                    </div>
                    <div>
                        <label for="">Kegiatan</label>
                        <textarea name="kegiatan" class="form-control" id="" cols="30" rows="10">{{$jurnal->kegiatan}}</textarea>
                    </div>
                    <div>
                        <label for="">Penilaian</label>
                        <textarea name="penilaian"  class="form-control" id="" cols="30" rows="10">{{$jurnal->penilaian}}</textarea>
                    </div>
                </div>
                <div class="col-6">
                    <div>
